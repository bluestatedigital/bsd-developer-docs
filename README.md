...
<div id="toc"><ul><li><a href="#-------------Blue-State-Digital-Trusted-API---------">1. 
            Blue State Digital Trusted API
        </a><ul><li><a href="#-----------------Overview-------------">1.1. 
                Overview
            </a></li><li><a href="#-----------------Common-Record-Formats-------------">1.2. 
                Common Record Formats
            </a><ul><li><a href="#-----------------Error-messages-------------">1.2.1. 
                Error messages
            </a><ul><li><a href="#-----------------Generic-Graph-API-Errors-------------">1.2.1.1. 
                Generic Graph API Errors
            </a></li><li><a href="#-----------------Permission-denied-------------">1.2.1.2. 
                Permission denied
            </a></li><li><a href="#-----------------Rate-limit-exceeded-------------">1.2.1.3. 
                Rate limit exceeded
            </a></li><li><a href="#-----------------Invalid-parameters-------------">1.2.1.4. 
                Invalid parameters
            </a></li></ul></li><li><a href="#-----------------Exported-JSON-Circle-Records-------------">1.2.2. 
                Exported JSON Circle Records
            </a><ul><li><a href="#-----------------Core--circle-------------">1.2.2.1. 
                Core: circle
            </a></li></ul></li></ul></li><li><a href="#-----------------Common-Query-Parameters-------------">1.3. 
                Common Query Parameters
            </a><ul><li><a href="#-----------------callback-------------">1.3.1. 
                callback
            </a></li></ul></li><li><a href="#-----------------Graph-API-Reference-------------">1.4. 
                Graph API Reference
            </a><ul><li><a href="#-----------------Circle-Graph-API-------------">1.4.1. 
                Circle Graph API
            </a><ul><li><a href="#----------------------circles-by_zip--zip--radius-----------------">1.4.1.1. 
                    /circles/by_zip/$zip/$radius
                </a></li></ul></li><li><a href="#-----------------Constituent-Graph-API-------------">1.4.2. 
                Constituent Graph API
            </a><ul><li><a href="#----------------------me-circles-----------------">1.4.2.1. 
                    /me/circles
                </a></li></ul></li><li><a href="#-----------------Event-RSVP-Graph-API-------------">1.4.3. 
                Event RSVP Graph API
            </a><ul><li><a href="#----------------------graph-addrsvp-----------------">1.4.3.1. 
                    /graph/addrsvp
                </a></li></ul></li><li><a href="#-----------------Actions-Graph-API-------------">1.4.4. 
                Actions Graph API
            </a><ul><li><a href="#----------------------getactions-----------------">1.4.4.1. 
                    /getactions
                </a></li></ul></li><li><a href="#-------------Ladder-of-Engagement-Graph-API---------">1.4.5. 
            Ladder of Engagement Graph API
        </a><ul><li><a href="#------------------loe--GUID-------------">1.4.5.1. 
                /loe/$GUID
            </a></li></ul></li></ul></li></ul></li><li><a href="#-------------Blue-State-Digital-XML-API---------">2. 
            Blue State Digital XML API
        </a><ul><li><a href="#-----------------Overview-------------0.5491667233873159">2.1. 
                Overview
            </a></li><li><a href="#-----------------Common-API-Parameters-------------">2.2. 
                Common API Parameters
            </a></li><li><a href="#-----------------Deferred-Results-------------">2.3. 
                Deferred Results
            </a><ul><li><a href="#-----------------Deferred-Result-Callbacks-------------">2.3.1. 
                Deferred Result Callbacks
            </a></li><li><a href="#-----------------Deferred-Results-API-Calls-------------">2.3.2. 
                Deferred Results API Calls
            </a><ul><li><a href="#---------------------get_deferred_results-----------------">2.3.2.1. 
                    get_deferred_results
                </a></li></ul></li></ul></li><li><a href="#-----------------Common-Record-Formats-------------0.6868029132019728">2.4. 
                Common Record Formats
            </a><ul><li><a href="#-----------------Exported-XML-Circle-Records-------------">2.4.1. 
                Exported XML Circle Records
            </a><ul><li><a href="#-----------------Core--circle-------------0.5388294602744281">2.4.1.1. 
                Core: circle
            </a></li></ul></li><li><a href="#-----------------Exported-XML-Constituent-Records-------------">2.4.2. 
                Exported XML Constituent Records
            </a><ul><li><a href="#-----------------Core--cons-------------">2.4.2.1. 
                Core: cons
            </a></li><li><a href="#-----------------Data-Bundle--circle-------------">2.4.2.2. 
                Data Bundle: circle
            </a></li><li><a href="#-----------------Data-Bundle--community_journal-------------">2.4.2.3. 
                Data Bundle: community_journal
            </a></li><li><a href="#-----------------Data-Bundle--cons_addr-------------">2.4.2.4. 
                Data Bundle: cons_addr
            </a></li><li><a href="#-----------------Data-Bundle--cons_email-and-primary_cons_email-------------">2.4.2.5. 
                Data Bundle: cons_email and primary_cons_email
            </a></li><li><a href="#-----------------Data-Bundle--cons_field-------------">2.4.2.6. 
                Data Bundle: cons_field
            </a></li><li><a href="#-----------------Data-Bundle--cons_friends-------------">2.4.2.7. 
                Data Bundle: cons_friends
            </a></li><li><a href="#-----------------Data-Bundle--cons_group-------------">2.4.2.8. 
                Data Bundle: cons_group
            </a></li><li><a href="#-----------------Data-Bundle--cons_phone-and-primary_cons_phone-------------">2.4.2.9. 
                Data Bundle: cons_phone and primary_cons_phone
            </a></li><li><a href="#-----------------Data-Bundle--event-------------">2.4.2.10. 
                Data Bundle: event
            </a></li><li><a href="#-----------------Data-Bundle--ext_X-------------">2.4.2.11. 
                Data Bundle: ext_X
            </a></li></ul></li><li><a href="#-----------------Incoming-XML-Constituent-Records-------------">2.4.3. 
                Incoming XML Constituent Records
            </a><ul><li><a href="#-----------------Core--cons-------------0.5194082870148122">2.4.3.1. 
                Core: cons
            </a></li><li><a href="#-----------------Data-Bundle--cons_addr-------------0.8383310027420521">2.4.3.2. 
                Data Bundle: cons_addr
            </a></li><li><a href="#-----------------Data-Bundle--cons_email-and-primary_cons_email-------------0.4196722968481481">2.4.3.3. 
                Data Bundle: cons_email and primary_cons_email
            </a></li><li><a href="#-----------------Data-Bundle--cons_group-------------0.5002809336874634">2.4.3.4. 
                Data Bundle: cons_group
            </a></li><li><a href="#-----------------Data-Bundle--cons_phone-and-primary_cons_phone-------------0.9267268052790314">2.4.3.5. 
                Data Bundle: cons_phone and primary_cons_phone
            </a></li><li><a href="#-----------------Data-Bundle--ext_X-------------0.059157671639695764">2.4.3.6. 
                Data Bundle: ext_X
            </a></li></ul></li><li><a href="#-----------------Exported-XML-Constituent-Group-Records-------------">2.4.4. 
                Exported XML Constituent Group Records
            </a><ul><li><a href="#-----------------Core--cons_group-------------">2.4.4.1. 
                Core: cons_group
            </a></li></ul></li><li><a href="#-----------------Incoming-XML-Constituent-Group-Records-------------">2.4.5. 
                Incoming XML Constituent Group Records
            </a><ul><li><a href="#-----------------Core--cons_group-------------0.14322069101035595">2.4.5.1. 
                Core: cons_group
            </a></li></ul></li><li><a href="#-----------------Exported-XML-Signup-Form-Records-------------">2.4.6. 
                Exported XML Signup Form Records
            </a><ul><li><a href="#-----------------Core--count_by_field-------------">2.4.6.1. 
                Core: count_by_field
            </a></li><li><a href="#-----------------Core--signup_count-------------">2.4.6.2. 
                Core: signup_count
            </a></li><li><a href="#-----------------Core--signup_form-------------">2.4.6.3. 
                Core: signup_form
            </a></li><li><a href="#-----------------Core--signup_form_field-------------">2.4.6.4. 
                Core: signup_form_field
            </a></li></ul></li><li><a href="#-----------------Exported-XML-Signup-Records-------------">2.4.7. 
                Exported XML Signup Records
            </a><ul><li><a href="#-----------------Core--stg_signups-------------">2.4.7.1. 
                Core: stg_signups
            </a></li></ul></li><li><a href="#-----------------Exported-XML-Wrapper-Records-------------">2.4.8. 
                Exported XML Wrapper Records
            </a><ul><li><a href="#-----------------Core--wrappers-------------">2.4.8.1. 
                Core: wrappers
            </a></li></ul></li><li><a href="#-----------------JSON-Event-Blobs-------------">2.4.9. 
                JSON Event Blobs
            </a><ul><li><a href="#-----------------Event--list_rsvps-------------">2.4.9.1. 
                Event: list_rsvps
            </a></li></ul></li><li><a href="#-----------------Bundle-Specification-------------">2.4.10. 
                Bundle Specification
            </a></li><li><a href="#-----------------Filter-Specification-------------">2.4.11. 
                Filter Specification
            </a></li></ul></li><li><a href="#-----------------API-Reference-------------">2.5. 
                API Reference
            </a><ul><li><a href="#-----------------Account-API-Calls-------------">2.5.1. 
                Account API Calls
            </a><ul><li><a href="#---------------------check_credentials-----------------">2.5.1.1. 
                    check_credentials
                </a></li><li><a href="#-----------------create_account-------------">2.5.1.2. 
                create_account
            </a></li><li><a href="#-----------------reset_password-------------">2.5.1.3. 
                reset_password
            </a></li><li><a href="#-----------------set_password-------------">2.5.1.4. 
                set_password
            </a></li></ul></li><li><a href="#-------------Branches-API-Calls---------">2.5.2. 
            Branches API Calls
        </a><ul><li><a href="#-----------------list_branches-------------">2.5.2.1. 
                list_branches
            </a></li></ul></li><li><a href="#-----------------Action-API-Calls-------------">2.5.3. 
                Action API Calls
            </a><ul><li><a href="#---------------------add-----------------">2.5.3.1. 
                    add
                </a></li><li><a href="#---------------------get-----------------">2.5.3.2. 
                    get
                </a></li></ul></li><li><a href="#-----------------Circle--circle--API-Calls-------------">2.5.4. 
                Circle (circle) API Calls
            </a><ul><li><a href="#---------------------list_circles-----------------">2.5.4.1. 
                    list_circles
                </a></li><li><a href="#---------------------get_cons_ids_for_circle-----------------">2.5.4.2. 
                    get_cons_ids_for_circle
                </a></li><li><a href="#---------------------get_ext_ids_for_circle-----------------">2.5.4.3. 
                    get_ext_ids_for_circle
                </a></li><li><a href="#---------------------set_cons_ids_for_circle-----------------">2.5.4.4. 
                    set_cons_ids_for_circle
                </a></li><li><a href="#---------------------set_ext_ids_for_circle-----------------">2.5.4.5. 
                    set_ext_ids_for_circle
                </a></li><li><a href="#---------------------add_cons_ids_to_circle-----------------">2.5.4.6. 
                    add_cons_ids_to_circle
                </a></li><li><a href="#---------------------add_ext_ids_to_circle-----------------">2.5.4.7. 
                    add_ext_ids_to_circle
                </a></li><li><a href="#---------------------remove_cons_ids_from_circle-----------------">2.5.4.8. 
                    remove_cons_ids_from_circle
                </a></li><li><a href="#---------------------remove_ext_ids_from_circle-----------------">2.5.4.9. 
                    remove_ext_ids_from_circle
                </a></li><li><a href="#---------------------move_cons_ids_to_circle-----------------">2.5.4.10. 
                    move_cons_ids_to_circle
                </a></li><li><a href="#---------------------move_ext_ids_to_circle-----------------">2.5.4.11. 
                    move_ext_ids_to_circle
                </a></li><li><a href="#---------------------set_circle_administrator-----------------">2.5.4.12. 
                    set_circle_administrator
                </a></li><li><a href="#---------------------demote_circle_administrator-----------------">2.5.4.13. 
                    demote_circle_administrator
                </a></li><li><a href="#---------------------set_circle_owner-----------------">2.5.4.14. 
                    set_circle_owner
                </a></li></ul></li><li><a href="#-----------------Constituent--cons--API-Calls-------------">2.5.5. 
                Constituent (cons) API Calls
            </a><ul><li><a href="#---------------------get_constituents_by_id-----------------">2.5.5.1. 
                    get_constituents_by_id
                </a></li><li><a href="#---------------------get_constituents-----------------">2.5.5.2. 
                    get_constituents
                </a></li><li><a href="#---------------------get_constituents_by_ext_id-----------------">2.5.5.3. 
                    get_constituents_by_ext_id
                </a></li><li><a href="#---------------------get_constituents_by_guid-----------------">2.5.5.4. 
                    get_constituents_by_guid
                </a></li><li><a href="#---------------------get_updated_constituents-----------------">2.5.5.5. 
                    get_updated_constituents
                </a></li><li><a href="#---------------------get_updated_constituent_ids-----------------">2.5.5.6. 
                    get_updated_constituent_ids
                </a></li><li><a href="#---------------------set_ext_ids-----------------">2.5.5.7. 
                    set_ext_ids
                </a></li><li><a href="#---------------------delete_constituents_by_id-----------------">2.5.5.8. 
                    delete_constituents_by_id
                </a></li><li><a href="#---------------------get_custom_constituent_fields-----------------">2.5.5.9. 
                    get_custom_constituent_fields
                </a></li><li><a href="#---------------------upload_bulk_constituent_data-----------------">2.5.5.10. 
                    upload_bulk_constituent_data
                </a></li><li><a href="#---------------------get_bulk_constituent_data-----------------">2.5.5.11. 
                    get_bulk_constituent_data
                </a></li><li><a href="#---------------------set_constituent_data-----------------">2.5.5.12. 
                    set_constituent_data
                </a></li><li><a href="#---------------------set_custom_constituent_fields-----------------">2.5.5.13. 
                    set_custom_constituent_fields
                </a></li><li><a href="#---------------------merge_constituents_by_email-----------------">2.5.5.14. 
                    merge_constituents_by_email
                </a></li><li><a href="#---------------------merge_constituents_by_id-----------------">2.5.5.15. 
                    merge_constituents_by_id
                </a></li><li><a href="#---------------------get_unsubscribed_constituents_by_group_id-----------------">2.5.5.16. 
                    get_unsubscribed_constituents_by_group_id
                </a></li><li><a href="#---------------------email_register-----------------">2.5.5.17. 
                    email_register
                </a></li><li><a href="#---------------------email_unsubscribe-----------------">2.5.5.18. 
                    email_unsubscribe
                </a></li><li><a href="#---------------------email_lookup-----------------">2.5.5.19. 
                    email_lookup
                </a></li><li><a href="#---------------------email_delete-----------------">2.5.5.20. 
                    email_delete
                </a></li><li><a href="#---------------------address_register-----------------">2.5.5.21. 
                    address_register
                </a></li><li><a href="#---------------------address_lookup-----------------">2.5.5.22. 
                    address_lookup
                </a></li><li><a href="#---------------------address_delete-----------------">2.5.5.23. 
                    address_delete
                </a></li><li><a href="#---------------------phone_register-----------------">2.5.5.24. 
                    phone_register
                </a></li><li><a href="#---------------------phone_unsubscribe-----------------">2.5.5.25. 
                    phone_unsubscribe
                </a></li><li><a href="#---------------------phone_lookup-----------------">2.5.5.26. 
                    phone_lookup
                </a></li><li><a href="#---------------------phone_delete-----------------">2.5.5.27. 
                    phone_delete
                </a></li></ul></li><li><a href="#-----------------Constituent-Group--cons_group--API-Calls-------------">2.5.6. 
                Constituent Group (cons_group) API Calls
            </a><ul><li><a href="#---------------------list_constituent_groups-----------------">2.5.6.1. 
                    list_constituent_groups
                </a></li><li><a href="#---------------------get_constituent_group-----------------">2.5.6.2. 
                    get_constituent_group
                </a></li><li><a href="#---------------------get_constituent_group_by_name-----------------">2.5.6.3. 
                    get_constituent_group_by_name
                </a></li><li><a href="#---------------------get_constituent_group_by_slug-----------------">2.5.6.4. 
                    get_constituent_group_by_slug
                </a></li><li><a href="#---------------------rename_group-----------------">2.5.6.5. 
                    rename_group
                </a></li><li><a href="#---------------------add_constituent_groups-----------------">2.5.6.6. 
                    add_constituent_groups
                </a></li><li><a href="#---------------------delete_constituent_groups-----------------">2.5.6.7. 
                    delete_constituent_groups
                </a></li><li><a href="#---------------------get_cons_ids_for_group-----------------">2.5.6.8. 
                    get_cons_ids_for_group
                </a></li><li><a href="#---------------------get_ext_ids_for_group-----------------">2.5.6.9. 
                    get_ext_ids_for_group
                </a></li><li><a href="#---------------------set_cons_ids_for_group-----------------">2.5.6.10. 
                    set_cons_ids_for_group
                </a></li><li><a href="#---------------------set_ext_ids_for_group-----------------">2.5.6.11. 
                    set_ext_ids_for_group
                </a></li><li><a href="#---------------------add_cons_ids_to_group-----------------">2.5.6.12. 
                    add_cons_ids_to_group
                </a></li><li><a href="#---------------------add_ext_ids_to_group-----------------">2.5.6.13. 
                    add_ext_ids_to_group
                </a></li><li><a href="#---------------------remove_cons_ids_from_group-----------------">2.5.6.14. 
                    remove_cons_ids_from_group
                </a></li><li><a href="#---------------------remove_ext_ids_from_group-----------------">2.5.6.15. 
                    remove_ext_ids_from_group
                </a></li></ul></li><li><a href="#-----------------Entity-API-Calls--entity--------------">2.5.7. 
                Entity API Calls (entity)
            </a><ul><li><a href="#---------------------fetch-----------------">2.5.7.1. 
                    fetch
                </a></li></ul></li><li><a href="#-----------------Core-API-Calls--core--------------">2.5.8. 
                Core API Calls (core)
            </a><ul><li><a href="#---------------------set_list-----------------">2.5.8.1. 
                    set_list
                </a></li></ul></li><li><a href="#-----------------Outreach--outreach--API-Calls-------------">2.5.9. 
                Outreach (outreach) API Calls
            </a><ul><li><a href="#---------------------get_page_by_id-----------------">2.5.9.1. 
                    get_page_by_id
                </a></li><li><a href="#---------------------set_page_data-----------------">2.5.9.2. 
                    set_page_data
                </a></li></ul></li><li><a href="#-----------------Share--share--API-Calls-------------">2.5.10. 
                Share (share) API Calls
            </a><ul><li><a href="#---------------------list_top_recruiters-----------------">2.5.10.1. 
                    list_top_recruiters
                </a></li></ul></li><li><a href="#-----------------Share-API-Calls-------------">2.5.11. 
                Share API Calls
            </a><ul><li><a href="#---------------------list_forms-----------------">2.5.11.1. 
                    list_forms
                </a></li><li><a href="#---------------------get_max_recipients-----------------">2.5.11.2. 
                    get_max_recipients
                </a></li><li><a href="#---------------------send_share-----------------">2.5.11.3. 
                    send_share
                </a></li></ul></li><li><a href="#-----------------Signup--signup--API-Calls-------------">2.5.12. 
                Signup (signup) API Calls
            </a><ul><li><a href="#---------------------list_forms-----------------0.15100545505993068">2.5.12.1. 
                    list_forms
                </a></li><li><a href="#---------------------get_form-----------------">2.5.12.2. 
                    get_form
                </a></li><li><a href="#---------------------list_form_fields-----------------">2.5.12.3. 
                    list_form_fields
                </a></li><li><a href="#---------------------signup_count-----------------">2.5.12.4. 
                    signup_count
                </a></li><li><a href="#---------------------count_by_field-----------------">2.5.12.5. 
                    count_by_field
                </a></li><li><a href="#---------------------process_signup-----------------">2.5.12.6. 
                    process_signup
                </a></li><li><a href="#---------------------get_signups_by_email-----------------">2.5.12.7. 
                    get_signups_by_email
                </a></li><li><a href="#---------------------get_signups_by_form_id-----------------">2.5.12.8. 
                    get_signups_by_form_id
                </a></li><li><a href="#---------------------clone_form-----------------">2.5.12.9. 
                    clone_form
                </a></li><li><a href="#-----------------set_cons_group-------------">2.5.12.10. 
                set_cons_group
            </a></li></ul></li><li><a href="#-------------Event-API-Calls---------">2.5.13. 
            Event API Calls
        </a><ul><li><a href="#-----------------search_events-------------">2.5.13.1. 
                search_events
            </a></li><li><a href="#-----------------list_rsvps-------------">2.5.13.2. 
                list_rsvps
            </a></li><li><a href="#-----------------create_event-------------">2.5.13.3. 
                create_event
            </a></li><li><a href="#-----------------update_event-------------">2.5.13.4. 
                update_event
            </a></li><li><a href="#-----------------get_event_details-------------">2.5.13.5. 
                get_event_details
            </a></li><li><a href="#-----------------get_event_parameter_details-------------">2.5.13.6. 
                get_event_parameter_details
            </a></li><li><a href="#-----------------get_create_event_requirements-------------">2.5.13.7. 
                get_create_event_requirements
            </a></li><li><a href="#-----------------get_update_event_requirements-------------">2.5.13.8. 
                get_update_event_requirements
            </a></li><li><a href="#-----------------get_events_for_cons-------------">2.5.13.9. 
                get_events_for_cons
            </a></li><li><a href="#-----------------get_available_types-------------">2.5.13.10. 
                get_available_types
            </a></li></ul></li><li><a href="#-------------VAN-Campaign-API-Calls---------">2.5.14. 
            VAN Campaign API Calls
        </a><ul><li><a href="#-----------------load_campaign_data-------------">2.5.14.1. 
                load_campaign_data
            </a></li><li><a href="#-----------------update_universe-------------">2.5.14.2. 
                update_universe
            </a></li><li><a href="#-----------------file_ready_for_download-------------">2.5.14.3. 
                file_ready_for_download
            </a></li><li><a href="#-----------------get_van_campaign_id-------------">2.5.14.4. 
                get_van_campaign_id
            </a></li></ul></li><li><a href="#-------------Wrappers-API-Calls---------">2.5.15. 
            Wrappers API Calls
        </a><ul><li><a href="#-----------------list_wrappers-------------">2.5.15.1. 
                list_wrappers
            </a></li></ul></li><li><a href="#-------------Contribution-API-Calls---------">2.5.16. 
            Contribution API Calls
        </a><ul><li><a href="#-----------------add_external_contribution-------------">2.5.16.1. 
                add_external_contribution
            </a></li><li><a href="#-----------------get_contributions-------------">2.5.16.2. 
                get_contributions
            </a></li><li><a href="#-----------------quick_donate_import-------------">2.5.16.3. 
                quick_donate_import
            </a></li><li><a href="#-----------------get_custom_form_fields-------------">2.5.16.4. 
                get_custom_form_fields
            </a></li><li><a href="#-----------------create_recurring-------------">2.5.16.5. 
                create_recurring
            </a></li><li><a href="#-----------------quick_donate_sms_optin_get-------------">2.5.16.6. 
                quick_donate_sms_optin_get
            </a></li><li><a href="#-----------------quick_donate_sms_optin_set-------------">2.5.16.7. 
                quick_donate_sms_optin_set
            </a></li><li><a href="#-----------------get_quickdonate_token-------------">2.5.16.8. 
                get_quickdonate_token
            </a></li></ul></li><li><a href="#-------------Mailer-API-Calls---------">2.5.17. 
            Mailer API Calls
        </a><ul><li><a href="#-----------------get_stats-------------">2.5.17.1. 
                get_stats
            </a></li></ul></li></ul></li><li><a href="#-----------------Understanding-the-api_mac-------------">2.6. 
                Understanding the api_mac
            </a><ul><li><a href="#-----------------Purpose-------------">2.6.1. 
                Purpose
            </a></li><li><a href="#-----------------Generating-an-api_mac-------------">2.6.2. 
                Generating an api_mac
            </a><ul><li><a href="#-----------------Step-1--Create-the-signing-string-------------">2.6.2.1. 
                Step 1: Create the signing string
            </a></li><li><a href="#-----------------Step-2--Use-HMAC-SHA1-to-get-the-api_mac-------------">2.6.2.2. 
                Step 2: Use HMAC-SHA1 to get the api_mac
            </a></li><li><a href="#-----------------Step-3--Assemble-the-request-------------">2.6.2.3. 
                Step 3: Assemble the request
            </a></li></ul></li><li><a href="#-----------------Code-Samples-and-Libraries-------------">2.6.3. 
                Code Samples and Libraries
            </a></li></ul></li><li><a href="#-----------------Common-HTTP-Status-Codes-------------">2.7. 
                Common HTTP Status Codes
            </a></li><li><a href="#-----------------Common-API-calling-issues-------------">2.8. 
